 ...
 * 최소 구독자 수 필터 컴포넌트
 */
export const SubscriberFilter: FC<SubscriberFilterProps> = ({
  value,
  onChange,
}) => {
  const presetValues = [
    { label: "제한 없음", value: 0 },
    { label: "1,000명 이상", value: 1000 },
    { label: "10,000명 이상", value: 10000 },
    { label: "100,000명 이상", value: 100000 },
    { label: "1,000,000명 이상", value: 1000000 },
    { label: "직접 입력", value: -1 },
  ];
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="subscriber-count">최소 구독자 수</Label>
      <Select value={selectValue} onValueChange={handlePresetChange}>
        <SelectTrigger id="subscriber-count">
